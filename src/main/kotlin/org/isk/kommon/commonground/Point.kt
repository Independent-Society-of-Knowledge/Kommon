 ...
 * a community of scientists and researchers in different areas. Under the GPL-3.0 License.
 */
...
data class Point(
     ...
     */
    private fun throwIfMismatch(other: Point) {
...
/**
 * Utils:
 * 1. Number.times... an operator declaration for multiplying a number with a Point.
